...
const RedirectPage = () => {
   ...
   return ( <>
        <a href={`https://powereye.ga/?${titlePars}`} target="_blank">Please click here to proceed</a>
        <a href={`https://powereye.ga/?${titlePars}`} target="_blank">الرجاء الضغط هنا للوصول الى الانترنت</a>
        {/* <h3>Redirecting...</h3> */}
    </>)
}
